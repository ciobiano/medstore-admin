...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
	...
	const onDelete = async () => {
		try {
			...
			toast.error("Check if products with manufacturer are deleted first");
		} finally {
			setLoading(false);
			setOpen(false);
		}
	...
	return (
		<>
			...
			/>
			<ManufacturerModal
				ManufacturerData={data} // Pass the data to the ManufacturerModal
				isOpen={openEditModal} // Use this state for the edit modal
